...
const HotelRegistration = () => {
  return (
    <div className='fixed top-0 bottom-0 left-0 right-0   z-100 flex items-center justify-center bg-black/70'>
        <form className='flex bg-white rounded-xl max-w-4xl max-md:mx-1'>
            <img src={assets.regImage} alt="reg-image" className='w-1/2 rounded-xl hidden md:block'/>
            <div className='relative flex flex-col  items-center md:w-1/2 p-6 md:p-8'>
            <img src={assets.closeIcon} alt="close-Icon"  className=' absolute top-4 right-4 h-4 w-4 cursor-pointer'/>
            <p className='text-2xl font-semibold mt-6'>Register Your Model</p>
            ...
            <div className='w-full mt-4 max-w-60 mr-auto'>
                     ...
                     <select id="city" className='border border-gray-200 rounded-full w-full px-3 py-2.5  mt-1 outline-indigo-500 font-light' required>
