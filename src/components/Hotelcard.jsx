...
const Hotelcard = ({room , index}) => {
  return (
    <Link to={'/rooms/' + room._id} onClick={() => scrollTo(0, 0)} className="relative w-[240px] max-w-70 overflow-hidden rounded-xl
   bg-white text-gray-500/90 shadow-[0_2px_8px_rgba(0,0,0,0.05)]">
